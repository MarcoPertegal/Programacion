...
public class Ppal {
	...
	public static void main(String[] args) {
		// EN la clase POJO creamos uin metodo que compara 
		//En las bases de datos no se ordenan pero cuando queremeos extraer unso cuantos datos de esa consulta si los ordenamos
		//Hace falta crear una clase para ordenar
		...
		do {
			...
			switch (opcionUser) {
				case 1:
					// ******************
					// Ordenamos todos los corredores por nombre, en orden alfabético
					System.out.println();
				...
				case 2:
					...
					Collections.sort(corredores);//el metodo sort nos ayuda a ordenar, es como el metodo leer, es un metodo estatico, este metodo sort, lo que hace es 
												//buscar en la clase corredir el metodo compareTo y ordena por ese criterio, en la clase pojo
					System.out.println();
					for (Corredor con : corredores) {
						System.out.println(con);
					}
				...
				case 3:
					...
					Collections.sort(corredores, new ComparaPorMarca());//si quiero comparar por nombre o marca hay qu pasarle la lista y la intancia de la clase
					System.out.println();
